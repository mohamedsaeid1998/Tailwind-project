...
import styles from "./TestmonialBox.module.scss"
export default function TestmonialBox({desc,image,name,position}) {
  return <>
  <div className='text-white bg-[#21293c] rounded-[5px] p-[30px] shadow-[8px_8px_1px_8px_#1c202c] '>
    ...
    <div className='flex items-center gap-[15px]' >
      ...
      <img src={image} alt="picture" className='w-[50px] h-[50px] rounded-full object-contain' />
